	...
	<div id="ContPrestamo">
		...
		<div id="ContDatos">
			...
			<form id="FormPrestamo">
				...
				<div>
					<label for="txtCarnetLe">Nro Carnet Estudiante:</label>
					<div>
						...
						<button class="btn btn-primary" type="button" onclick="VerificarLector()">Verificar</button>
					</div>
				...
				<div id="botones">
					<button class="btn btn-success bi-file-plus" type="button" onclick="GuardarPrestamo();">  Guardar</button>
					<button class="btn btn-danger bi-x-octagon"  type="button" onclick="VistaInicio();">  Cancelar</button>
				</div>
		...
		<div class="row" id="ContListLibros">
