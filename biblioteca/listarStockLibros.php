...
SELECT LI.CodLibro AS Codigo, LI.Titulo AS Titulo, LI.Codigo AS Dewey,LI.Ubicacion AS Ubicacion, AU.Descripcion AS Autor,ED.Descripcion AS Editorial, GE.Descripcion AS Genero, SL.Descripcion AS Disponibles
FROM stocklibros SL
